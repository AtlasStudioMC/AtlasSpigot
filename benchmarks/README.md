...
[Benchmarks](https://www.atlas.dev/benchmarks) page (real MSPT comparison, Atlas vs
stock Paper, 1.21.4).
...
seed `2618050634530417871`, coords `183 67 -201`. Atlas ran with this project's documented
...
each. Atlas: 121.868s. Paper: 134.805s.
